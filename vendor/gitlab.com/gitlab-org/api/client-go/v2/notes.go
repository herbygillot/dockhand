...
var (
	routeGroupsIDEpicsIDNotes             = route("groups/%s/epics/%d/notes")
	routeGroupsIDEpicsIDNotesID           = route("groups/%s/epics/%d/notes/%d")
	routeProjectsIDIssuesIDNotes          = route("projects/%s/issues/%d/notes")
	routeProjectsIDIssuesIDNotesID        = route("projects/%s/issues/%d/notes/%d")
	routeProjectsIDMergeRequestsIDNotes   = route("projects/%s/merge_requests/%d/notes")
	routeProjectsIDMergeRequestsIDNotesID = route("projects/%s/merge_requests/%d/notes/%d")
	routeProjectsIDSnippetsIDNotes        = route("projects/%s/snippets/%d/notes")
	routeProjectsIDSnippetsIDNotesID      = route("projects/%s/snippets/%d/notes/%d")
)
...
func (s *NotesService) ListIssueNotes(pid any, issue int64, opt *ListIssueNotesOptions, options ...RequestOptionFunc) ([]*Note, *Response, error) {
	return do[[]*Note](s.client,
		withPath(routeProjectsIDIssuesIDNotes, ProjectID{pid}, issue),
		withAPIOpts(opt),
...
func (s *NotesService) GetIssueNote(pid any, issue, note int64, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withPath(routeProjectsIDIssuesIDNotesID, ProjectID{pid}, issue, note),
		withRequestOpts(options...),
	)
}
...
func (s *NotesService) ListSnippetNotes(pid any, snippet int64, opt *ListSnippetNotesOptions, options ...RequestOptionFunc) ([]*Note, *Response, error) {
	return do[[]*Note](s.client,
		withPath(routeProjectsIDSnippetsIDNotes, ProjectID{pid}, snippet),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *NotesService) GetSnippetNote(pid any, snippet, note int64, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withPath(routeProjectsIDSnippetsIDNotesID, ProjectID{pid}, snippet, note),
		withRequestOpts(options...),
	)
}
...
func (s *NotesService) ListMergeRequestNotes(pid any, mergeRequest int64, opt *ListMergeRequestNotesOptions, options ...RequestOptionFunc) ([]*Note, *Response, error) {
	return do[[]*Note](s.client,
		withPath(routeProjectsIDMergeRequestsIDNotes, ProjectID{pid}, mergeRequest),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *NotesService) GetMergeRequestNote(pid any, mergeRequest, note int64, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withPath(routeProjectsIDMergeRequestsIDNotesID, ProjectID{pid}, mergeRequest, note),
		withRequestOpts(options...),
	)
}
...
func (s *NotesService) ListEpicNotes(gid any, epic int64, opt *ListEpicNotesOptions, options ...RequestOptionFunc) ([]*Note, *Response, error) {
	return do[[]*Note](s.client,
		withPath(routeGroupsIDEpicsIDNotes, GroupID{gid}, epic),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *NotesService) GetEpicNote(gid any, epic, note int64, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withPath(routeGroupsIDEpicsIDNotesID, GroupID{gid}, epic, note),
		withRequestOpts(options...),
	)
}
