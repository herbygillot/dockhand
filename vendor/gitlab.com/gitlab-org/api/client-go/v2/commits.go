...
var (
	routeProjectsIDRepositoryCommits                = route("projects/%s/repository/commits")
	routeProjectsIDRepositoryCommitsID              = route("projects/%s/repository/commits/%s")
	routeProjectsIDRepositoryCommitsIDCherryPick    = route("projects/%s/repository/commits/%s/cherry_pick")
	routeProjectsIDRepositoryCommitsIDComments      = route("projects/%s/repository/commits/%s/comments")
	routeProjectsIDRepositoryCommitsIDDiff          = route("projects/%s/repository/commits/%s/diff")
	routeProjectsIDRepositoryCommitsIDMergeRequests = route("projects/%s/repository/commits/%s/merge_requests")
	routeProjectsIDRepositoryCommitsIDRefs          = route("projects/%s/repository/commits/%s/refs")
	routeProjectsIDRepositoryCommitsIDRevert        = route("projects/%s/repository/commits/%s/revert")
	routeProjectsIDRepositoryCommitsIDSignature     = route("projects/%s/repository/commits/%s/signature")
	routeProjectsIDRepositoryCommitsIDStatuses      = route("projects/%s/repository/commits/%s/statuses")
	routeProjectsIDStatusesID                       = route("projects/%s/statuses/%s")
)
...
func (s *CommitsService) ListCommits(pid any, opt *ListCommitsOptions, options ...RequestOptionFunc) ([]*Commit, *Response, error) {
	return do[[]*Commit](s.client,
		...
		withPath(routeProjectsIDRepositoryCommits, ProjectID{pid}),
		withAPIOpts(opt),
...
func (s *CommitsService) GetCommitRefs(pid any, sha string, opt *GetCommitRefsOptions, options ...RequestOptionFunc) ([]*CommitRef, *Response, error) {
	return do[[]*CommitRef](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDRepositoryCommitsIDRefs, ProjectID{pid}, sha),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *CommitsService) GetCommit(pid any, sha string, opt *GetCommitOptions, options ...RequestOptionFunc) (*Commit, *Response, error) {
	...
	return do[*Commit](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDRepositoryCommitsID, ProjectID{pid}, sha),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *CommitsService) GetCommitDiff(pid any, sha string, opt *GetCommitDiffOptions, options ...RequestOptionFunc) ([]*Diff, *Response, error) {
	return do[[]*Diff](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDRepositoryCommitsIDDiff, ProjectID{pid}, sha),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *CommitsService) GetCommitComments(pid any, sha string, opt *GetCommitCommentsOptions, options ...RequestOptionFunc) ([]*CommitComment, *Response, error) {
	return do[[]*CommitComment](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDRepositoryCommitsIDComments, ProjectID{pid}, sha),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *CommitsService) GetCommitStatuses(pid any, sha string, opt *GetCommitStatusesOptions, options ...RequestOptionFunc) ([]*CommitStatus, *Response, error) {
	return do[[]*CommitStatus](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDRepositoryCommitsIDStatuses, ProjectID{pid}, sha),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *CommitsService) SetCommitStatus(pid any, sha string, opt *SetCommitStatusOptions, options ...RequestOptionFunc) (*CommitStatus, *Response, error) {
	return do[*CommitStatus](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDStatusesID, ProjectID{pid}, sha),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *CommitsService) ListMergeRequestsByCommit(pid any, sha string, options ...RequestOptionFunc) ([]*BasicMergeRequest, *Response, error) {
	return do[[]*BasicMergeRequest](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDRepositoryCommitsIDMergeRequests, ProjectID{pid}, sha),
		withRequestOpts(options...),
	)
}
...
func (s *CommitsService) CherryPickCommit(pid any, sha string, opt *CherryPickCommitOptions, options ...RequestOptionFunc) (*Commit, *Response, error) {
	return do[*Commit](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDRepositoryCommitsIDCherryPick, ProjectID{pid}, sha),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *CommitsService) RevertCommit(pid any, sha string, opt *RevertCommitOptions, options ...RequestOptionFunc) (*Commit, *Response, error) {
	return do[*Commit](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDRepositoryCommitsIDRevert, ProjectID{pid}, sha),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *CommitsService) GetGPGSignature(pid any, sha string, options ...RequestOptionFunc) (*GPGSignature, *Response, error) {
	return do[*GPGSignature](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDRepositoryCommitsIDSignature, ProjectID{pid}, sha),
		withRequestOpts(options...),
	)
}
