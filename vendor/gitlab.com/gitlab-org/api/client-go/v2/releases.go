...
var (
	routeProjectsIDReleases                = route("projects/%s/releases")
	routeProjectsIDReleasesID              = route("projects/%s/releases/%s")
	routeProjectsIDReleasesPermalinkLatest = route("projects/%s/releases/permalink/latest")
)
...
func (s *ReleasesService) ListReleases(pid any, opt *ListReleasesOptions, options ...RequestOptionFunc) ([]*Release, *Response, error) {
	return do[[]*Release](s.client,
		withPath(routeProjectsIDReleases, ProjectID{pid}),
		withAPIOpts(opt),
...
func (s *ReleasesService) GetRelease(pid any, tagName string, options ...RequestOptionFunc) (*Release, *Response, error) {
	return do[*Release](s.client,
		withPath(routeProjectsIDReleasesID, ProjectID{pid}, tagName),
		withRequestOpts(options...),
	)
}
...
func (s *ReleasesService) GetLatestRelease(pid any, options ...RequestOptionFunc) (*Release, *Response, error) {
	return do[*Release](s.client,
		withPath(routeProjectsIDReleasesPermalinkLatest, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
