...
var (
	routeProjectsIDRepositoryFilesID      = route("projects/%s/repository/files/%s")
	routeProjectsIDRepositoryFilesIDBlame = route("projects/%s/repository/files/%s/blame")
	routeProjectsIDRepositoryFilesIDRaw   = route("projects/%s/repository/files/%s/raw")
)
...
type (
	RepositoryFilesServiceInterface interface {
		...
		GetRawFileReader(pid any, fileName string, opt *GetRawFileOptions, options ...RequestOptionFunc) (io.ReadCloser, *Response, error)
...
func (s *RepositoryFilesService) GetFile(pid any, fileName string, opt *GetFileOptions, options ...RequestOptionFunc) (*File, *Response, error) {
	return do[*File](s.client,
		withPath(routeProjectsIDRepositoryFilesID, ProjectID{pid}, fileName),
		withAPIOpts(opt),
...
func (s *RepositoryFilesService) GetFileBlame(pid any, file string, opt *GetFileBlameOptions, options ...RequestOptionFunc) ([]*FileBlameRange, *Response, error) {
	return do[[]*FileBlameRange](s.client,
		withPath(routeProjectsIDRepositoryFilesIDBlame, ProjectID{pid}, file),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *RepositoryFilesService) GetRawFile(pid any, fileName string, opt *GetRawFileOptions, options ...RequestOptionFunc) ([]byte, *Response, error) {
	buf, resp, err := do[bytes.Buffer](s.client,
		withPath(routeProjectsIDRepositoryFilesIDRaw, ProjectID{pid}, fileName),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	if err != nil {
...
// GetRawFileReader gets the contents of a raw file from a repository as a
// stream, which avoids buffering the whole file in memory.
//
...
// GitLab API docs:
// https://docs.gitlab.com/api/repository_files/#get-raw-file-from-repository
func (s *RepositoryFilesService) GetRawFileReader(pid any, fileName string, opt *GetRawFileOptions, options ...RequestOptionFunc) (io.ReadCloser, *Response, error) {
