...
var (
	routeProjectsIDIssuesIDResourceMilestoneEvents          = route("projects/%s/issues/%d/resource_milestone_events")
	routeProjectsIDIssuesIDResourceMilestoneEventsID        = route("projects/%s/issues/%d/resource_milestone_events/%d")
	routeProjectsIDMergeRequestsIDResourceMilestoneEvents   = route("projects/%s/merge_requests/%d/resource_milestone_events")
	routeProjectsIDMergeRequestsIDResourceMilestoneEventsID = route("projects/%s/merge_requests/%d/resource_milestone_events/%d")
)
...
func (s *ResourceMilestoneEventsService) ListIssueMilestoneEvents(pid any, issue int64, opt *ListMilestoneEventsOptions, options ...RequestOptionFunc) ([]*MilestoneEvent, *Response, error) {
	return do[[]*MilestoneEvent](s.client,
		withPath(routeProjectsIDIssuesIDResourceMilestoneEvents, ProjectID{pid}, issue),
		withAPIOpts(opt),
...
func (s *ResourceMilestoneEventsService) GetIssueMilestoneEvent(pid any, issue int64, event int64, options ...RequestOptionFunc) (*MilestoneEvent, *Response, error) {
	return do[*MilestoneEvent](s.client,
		withPath(routeProjectsIDIssuesIDResourceMilestoneEventsID, ProjectID{pid}, issue, event),
		withRequestOpts(options...),
	)
}
...
func (s *ResourceMilestoneEventsService) ListMergeMilestoneEvents(pid any, request int64, opt *ListMilestoneEventsOptions, options ...RequestOptionFunc) ([]*MilestoneEvent, *Response, error) {
	return do[[]*MilestoneEvent](s.client,
		withPath(routeProjectsIDMergeRequestsIDResourceMilestoneEvents, ProjectID{pid}, request),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ResourceMilestoneEventsService) GetMergeRequestMilestoneEvent(pid any, request int64, event int64, options ...RequestOptionFunc) (*MilestoneEvent, *Response, error) {
	return do[*MilestoneEvent](s.client,
		withPath(routeProjectsIDMergeRequestsIDResourceMilestoneEventsID, ProjectID{pid}, request, event),
		withRequestOpts(options...),
	)
}
