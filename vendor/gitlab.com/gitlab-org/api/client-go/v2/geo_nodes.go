...
var (
	routeGeoNodes         = route("geo_nodes")
	routeGeoNodesID       = route("geo_nodes/%d")
	routeGeoNodesIDRepair = route("geo_nodes/%d/repair")
	routeGeoNodesIDStatus = route("geo_nodes/%d/status")
	routeGeoNodesStatus   = route("geo_nodes/status")
)
...
func (s *GeoNodesService) RepairGeoNode(id int64, options ...RequestOptionFunc) (*GeoNode, *Response, error) {
	return do[*GeoNode](s.client,
		withMethod(http.MethodPost),
		withPath(routeGeoNodesIDRepair, id),
		withRequestOpts(options...),
	)
}
...
func (s *GeoNodesService) RetrieveStatusOfGeoNode(id int64, options ...RequestOptionFunc) (*GeoNodeStatus, *Response, error) {
	return do[*GeoNodeStatus](s.client,
		withPath(routeGeoNodesIDStatus, id),
		withRequestOpts(options...),
	)
}
