...
var (
	routeProjectsIDRepositoryTags            = route("projects/%s/repository/tags")
	routeProjectsIDRepositoryTagsID          = route("projects/%s/repository/tags/%s")
	routeProjectsIDRepositoryTagsIDSignature = route("projects/%s/repository/tags/%s/signature")
)
...
func (s *TagsService) ListTags(pid any, opt *ListTagsOptions, options ...RequestOptionFunc) ([]*Tag, *Response, error) {
	return do[[]*Tag](s.client,
		withPath(routeProjectsIDRepositoryTags, ProjectID{pid}),
		withAPIOpts(opt),
...
func (s *TagsService) GetTag(pid any, tag string, options ...RequestOptionFunc) (*Tag, *Response, error) {
	return do[*Tag](s.client,
		withPath(routeProjectsIDRepositoryTagsID, ProjectID{pid}, tag),
		withRequestOpts(options...),
	)
}
...
func (s *TagsService) GetTagSignature(pid any, tag string, options ...RequestOptionFunc) (*X509Signature, *Response, error) {
	return do[*X509Signature](s.client,
		withPath(routeProjectsIDRepositoryTagsIDSignature, ProjectID{pid}, tag),
		withRequestOpts(options...),
	)
}
