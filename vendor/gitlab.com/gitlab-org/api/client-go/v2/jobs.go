...
var (
	routeJob                               = route("job")
	routeProjectsIDArtifacts               = route("projects/%s/artifacts")
	routeProjectsIDJobs                    = route("projects/%s/jobs")
	routeProjectsIDJobsArtifactsIDDownload = route("projects/%s/jobs/artifacts/%s/download")
	routeProjectsIDJobsArtifactsIDRawID    = route("projects/%s/jobs/artifacts/%s/raw/%s")
	routeProjectsIDJobsID                  = route("projects/%s/jobs/%d")
	routeProjectsIDJobsIDArtifacts         = route("projects/%s/jobs/%d/artifacts")
	routeProjectsIDJobsIDArtifactsID       = route("projects/%s/jobs/%d/artifacts/%s")
	routeProjectsIDJobsIDArtifactsKeep     = route("projects/%s/jobs/%d/artifacts/keep")
	routeProjectsIDJobsIDCancel            = route("projects/%s/jobs/%d/cancel")
	routeProjectsIDJobsIDErase             = route("projects/%s/jobs/%d/erase")
	routeProjectsIDJobsIDPlay              = route("projects/%s/jobs/%d/play")
	routeProjectsIDJobsIDRetry             = route("projects/%s/jobs/%d/retry")
	routeProjectsIDJobsIDTrace             = route("projects/%s/jobs/%d/trace")
	routeProjectsIDPipelinesIDBridges      = route("projects/%s/pipelines/%d/bridges")
	routeProjectsIDPipelinesIDJobs         = route("projects/%s/pipelines/%d/jobs")
)
...
func (s *JobsService) ListProjectJobs(pid any, opts *ListJobsOptions, options ...RequestOptionFunc) ([]*Job, *Response, error) {
	return do[[]*Job](s.client,
		...
		withPath(routeProjectsIDJobs, ProjectID{pid}),
		withAPIOpts(opts),
...
func (s *JobsService) ListPipelineJobs(pid any, pipelineID int64, opts *ListJobsOptions, options ...RequestOptionFunc) ([]*Job, *Response, error) {
	return do[[]*Job](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDPipelinesIDJobs, ProjectID{pid}, pipelineID),
		withAPIOpts(opts),
		withRequestOpts(options...),
	)
}
...
func (s *JobsService) ListPipelineBridges(pid any, pipelineID int64, opts *ListJobsOptions, options ...RequestOptionFunc) ([]*Bridge, *Response, error) {
	return do[[]*Bridge](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDPipelinesIDBridges, ProjectID{pid}, pipelineID),
		withAPIOpts(opts),
		withRequestOpts(options...),
	)
}
...
func (s *JobsService) GetJob(pid any, jobID int64, options ...RequestOptionFunc) (*Job, *Response, error) {
	return do[*Job](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDJobsID, ProjectID{pid}, jobID),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
}
...
func (s *JobsService) DownloadArtifactsFile(pid any, refName string, opt *DownloadArtifactsFileOptions, options ...RequestOptionFunc) (*bytes.Reader, *Response, error) {
	b, resp, err := do[bytes.Buffer](s.client,
		withPath(routeProjectsIDJobsArtifactsIDDownload, ProjectID{pid}, NoEscape{refName}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
...
func (s *JobsService) DownloadSingleArtifactsFile(pid any, jobID int64, artifactPath string, options ...RequestOptionFunc) (*bytes.Reader, *Response, error) {
	b, resp, err := do[bytes.Buffer](s.client,
		withPath(routeProjectsIDJobsIDArtifactsID, ProjectID{pid}, jobID, NoEscape{artifactPath}),
		withRequestOpts(options...),
	)
...
func (s *JobsService) DownloadSingleArtifactsFileByTagOrBranch(pid any, refName string, artifactPath string, opt *DownloadArtifactsFileOptions, options ...RequestOptionFunc) (*bytes.Reader, *Response, error) {
	b, resp, err := do[bytes.Buffer](s.client,
		withPath(routeProjectsIDJobsArtifactsIDRawID, ProjectID{pid}, refName, NoEscape{artifactPath}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
...
func (s *JobsService) GetTraceFile(pid any, jobID int64, options ...RequestOptionFunc) (*bytes.Reader, *Response, error) {
	b, resp, err := do[bytes.Buffer](s.client,
		withPath(routeProjectsIDJobsIDTrace, ProjectID{pid}, jobID),
		withRequestOpts(options...),
	)
...
func (s *JobsService) CancelJobWithOptions(pid any, jobID int64, opt *CancelJobOptions, options ...RequestOptionFunc) (*Job, *Response, error) {
	return do[*Job](s.client,
		...
		withPath(routeProjectsIDJobsIDCancel, ProjectID{pid}, jobID),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *JobsService) RetryJob(pid any, jobID int64, options ...RequestOptionFunc) (*Job, *Response, error) {
	return do[*Job](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDJobsIDRetry, ProjectID{pid}, jobID),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
}
...
func (s *JobsService) EraseJob(pid any, jobID int64, options ...RequestOptionFunc) (*Job, *Response, error) {
	return do[*Job](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDJobsIDErase, ProjectID{pid}, jobID),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
}
...
func (s *JobsService) KeepArtifacts(pid any, jobID int64, options ...RequestOptionFunc) (*Job, *Response, error) {
	return do[*Job](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDJobsIDArtifactsKeep, ProjectID{pid}, jobID),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
}
...
func (s *JobsService) PlayJob(pid any, jobID int64, opt *PlayJobOptions, options ...RequestOptionFunc) (*Job, *Response, error) {
	return do[*Job](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDJobsIDPlay, ProjectID{pid}, jobID),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *JobsService) DeleteProjectArtifacts(pid any, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		withMethod(http.MethodDelete),
		withPath(routeProjectsIDArtifacts, ProjectID{pid}),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
	return resp, err
