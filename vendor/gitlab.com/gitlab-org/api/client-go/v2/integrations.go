...
var (
	routeGroupsIDIntegrations               = route("groups/%s/integrations")
	routeGroupsIDIntegrationsDiscord        = route("groups/%s/integrations/discord")
	routeGroupsIDIntegrationsHangoutsChat   = route("groups/%s/integrations/hangouts-chat")
	routeGroupsIDIntegrationsHarbor         = route("groups/%s/integrations/harbor")
	routeGroupsIDIntegrationsJira           = route("groups/%s/integrations/jira")
	routeGroupsIDIntegrationsMatrix         = route("groups/%s/integrations/matrix")
	routeGroupsIDIntegrationsMicrosoftTeams = route("groups/%s/integrations/microsoft-teams")
	routeGroupsIDIntegrationsSlack          = route("groups/%s/integrations/slack")
	routeGroupsIDIntegrationsTelegram       = route("groups/%s/integrations/telegram")
	routeGroupsIDIntegrationsWebexTeams     = route("groups/%s/integrations/webex-teams")
	routeProjectsIDIntegrationsHangoutsChat = route("projects/%s/integrations/hangouts-chat")
)
...
func (s *IntegrationsService) ListActiveGroupIntegrations(gid any, opt *ListActiveIntegrationsOptions, options ...RequestOptionFunc) ([]*Integration, *Response, error) {
	return do[[]*Integration](
		s.client,
		withPath(routeGroupsIDIntegrations, GroupID{gid}),
...
func (s *IntegrationsService) SetUpGroupHarbor(gid any, opt *SetUpHarborOptions, options ...RequestOptionFunc) (*HarborIntegration, *Response, error) {
	return do[*HarborIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsHarbor, GroupID{gid}),
...
func (s *IntegrationsService) SetGroupMicrosoftTeamsNotifications(gid any, opt *SetMicrosoftTeamsNotificationsOptions, options ...RequestOptionFunc) (*MicrosoftTeamsIntegration, *Response, error) {
	return do[*MicrosoftTeamsIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsMicrosoftTeams, GroupID{gid}),
		withMethod(http.MethodPut),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
...
func (s *IntegrationsService) SetUpGroupJira(gid any, opt *SetUpJiraOptions, options ...RequestOptionFunc) (*JiraIntegration, *Response, error) {
	return do[*JiraIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsJira, GroupID{gid}),
		withMethod(http.MethodPut),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
...
func (s *IntegrationsService) SetGroupSlackSettings(gid any, opt *SetGroupSlackOptions, options ...RequestOptionFunc) (*SlackIntegration, *Response, error) {
	return do[*SlackIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsSlack, GroupID{gid}),
		withMethod(http.MethodPut),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
...
func (s *IntegrationsService) GetGroupDiscordSettings(gid any, options ...RequestOptionFunc) (*DiscordIntegration, *Response, error) {
	return do[*DiscordIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsDiscord, GroupID{gid}),
		withMethod(http.MethodGet),
		withRequestOpts(options...),
	)
}
...
func (s *IntegrationsService) GetGroupTelegramSettings(gid any, options ...RequestOptionFunc) (*TelegramIntegration, *Response, error) {
	return do[*TelegramIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsTelegram, GroupID{gid}),
		withMethod(http.MethodGet),
		withRequestOpts(options...),
	)
}
...
func (s *IntegrationsService) GetGroupMattermostSettings(gid any, options ...RequestOptionFunc) (*MattermostIntegration, *Response, error) {
	return do[*MattermostIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsMattermost, GroupID{gid}),
		withMethod(http.MethodGet),
		withRequestOpts(options...),
	)
}
...
func (s *IntegrationsService) GetGroupMatrixSettings(gid any, options ...RequestOptionFunc) (*MatrixIntegration, *Response, error) {
	return do[*MatrixIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsMatrix, GroupID{gid}),
		withMethod(http.MethodGet),
		withRequestOpts(options...),
	)
}
...
func (s *IntegrationsService) GetGroupGoogleChatSettings(gid any, options ...RequestOptionFunc) (*GoogleChatIntegration, *Response, error) {
	return do[*GoogleChatIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsHangoutsChat, GroupID{gid}),
		withMethod(http.MethodGet),
		withRequestOpts(options...),
	)
}
...
func (s *IntegrationsService) SetProjectGoogleChatSettings(pid any, opt *SetProjectGoogleChatOptions, options ...RequestOptionFunc) (*GoogleChatIntegration, *Response, error) {
	return do[*GoogleChatIntegration](
		s.client,
		withPath(routeProjectsIDIntegrationsHangoutsChat, ProjectID{pid}),
		withMethod(http.MethodPut),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
...
func (s *IntegrationsService) GetGroupWebexTeamsSettings(gid any, options ...RequestOptionFunc) (*WebexTeamsIntegration, *Response, error) {
	return do[*WebexTeamsIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsWebexTeams, GroupID{gid}),
		withMethod(http.MethodGet),
		withRequestOpts(options...),
	)
}
