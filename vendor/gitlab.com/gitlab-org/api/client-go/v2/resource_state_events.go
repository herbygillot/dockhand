...
var (
	routeProjectsIDIssuesIDResourceStateEvents          = route("projects/%s/issues/%d/resource_state_events")
	routeProjectsIDIssuesIDResourceStateEventsID        = route("projects/%s/issues/%d/resource_state_events/%d")
	routeProjectsIDMergeRequestsIDResourceStateEvents   = route("projects/%s/merge_requests/%d/resource_state_events")
	routeProjectsIDMergeRequestsIDResourceStateEventsID = route("projects/%s/merge_requests/%d/resource_state_events/%d")
)
...
func (s *ResourceStateEventsService) ListIssueStateEvents(pid any, issue int64, opt *ListStateEventsOptions, options ...RequestOptionFunc) ([]*StateEvent, *Response, error) {
	return do[[]*StateEvent](s.client,
		withPath(routeProjectsIDIssuesIDResourceStateEvents, ProjectID{pid}, issue),
		withAPIOpts(opt),
...
func (s *ResourceStateEventsService) GetIssueStateEvent(pid any, issue int64, event int64, options ...RequestOptionFunc) (*StateEvent, *Response, error) {
	return do[*StateEvent](s.client,
		withPath(routeProjectsIDIssuesIDResourceStateEventsID, ProjectID{pid}, issue, event),
		withRequestOpts(options...),
	)
}
...
func (s *ResourceStateEventsService) ListMergeStateEvents(pid any, request int64, opt *ListStateEventsOptions, options ...RequestOptionFunc) ([]*StateEvent, *Response, error) {
	return do[[]*StateEvent](s.client,
		withPath(routeProjectsIDMergeRequestsIDResourceStateEvents, ProjectID{pid}, request),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ResourceStateEventsService) GetMergeRequestStateEvent(pid any, request int64, event int64, options ...RequestOptionFunc) (*StateEvent, *Response, error) {
	return do[*StateEvent](s.client,
		withPath(routeProjectsIDMergeRequestsIDResourceStateEventsID, ProjectID{pid}, request, event),
		withRequestOpts(options...),
	)
}
