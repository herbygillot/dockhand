...
var (
	routeGeoSites         = route("geo_sites")
	routeGeoSitesID       = route("geo_sites/%d")
	routeGeoSitesIDRepair = route("geo_sites/%d/repair")
	routeGeoSitesIDStatus = route("geo_sites/%d/status")
	routeGeoSitesStatus   = route("geo_sites/status")
)
...
func (s *GeoSitesService) RepairGeoSite(id int64, options ...RequestOptionFunc) (*GeoSite, *Response, error) {
	return do[*GeoSite](s.client,
		withMethod(http.MethodPost),
		withPath(routeGeoSitesIDRepair, id),
		withRequestOpts(options...),
	)
}
...
func (s *GeoSitesService) GetStatusOfGeoSite(id int64, options ...RequestOptionFunc) (*GeoSiteStatus, *Response, error) {
	return do[*GeoSiteStatus](s.client,
		withPath(routeGeoSitesIDStatus, id),
		withRequestOpts(options...),
	)
}
