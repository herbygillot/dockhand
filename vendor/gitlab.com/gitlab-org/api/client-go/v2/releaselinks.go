...
var (
	routeProjectsIDReleasesIDAssetsLinks   = route("projects/%s/releases/%s/assets/links")
	routeProjectsIDReleasesIDAssetsLinksID = route("projects/%s/releases/%s/assets/links/%d")
)
...
func (s *ReleaseLinksService) ListReleaseLinks(pid any, tagName string, opt *ListReleaseLinksOptions, options ...RequestOptionFunc) ([]*ReleaseLink, *Response, error) {
	return do[[]*ReleaseLink](s.client,
		withPath(routeProjectsIDReleasesIDAssetsLinks, ProjectID{pid}, tagName),
		withAPIOpts(opt),
...
func (s *ReleaseLinksService) GetReleaseLink(pid any, tagName string, link int64, options ...RequestOptionFunc) (*ReleaseLink, *Response, error) {
	return do[*ReleaseLink](s.client,
		withPath(routeProjectsIDReleasesIDAssetsLinksID, ProjectID{pid}, tagName, link),
		withRequestOpts(options...),
	)
}
