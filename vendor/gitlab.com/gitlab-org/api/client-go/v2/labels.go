...
var (
	routeProjectsIDLabels              = route("projects/%s/labels")
	routeProjectsIDLabelsID            = route("projects/%s/labels/%s")
	routeProjectsIDLabelsIDPromote     = route("projects/%s/labels/%s/promote")
	routeProjectsIDLabelsIDSubscribe   = route("projects/%s/labels/%s/subscribe")
	routeProjectsIDLabelsIDUnsubscribe = route("projects/%s/labels/%s/unsubscribe")
)
...
func (s *LabelsService) ListLabels(pid any, opt *ListLabelsOptions, options ...RequestOptionFunc) ([]*Label, *Response, error) {
	return do[[]*Label](s.client,
		withPath(routeProjectsIDLabels, ProjectID{pid}),
		withAPIOpts(opt),
...
func (s *LabelsService) GetLabel(pid any, lid any, options ...RequestOptionFunc) (*Label, *Response, error) {
	return do[*Label](s.client,
		withPath(routeProjectsIDLabelsID, ProjectID{pid}, LabelID{lid}),
		withRequestOpts(options...),
	)
}
...
func (s *LabelsService) DeleteLabel(pid any, lid any, opt *DeleteLabelOptions, options ...RequestOptionFunc) (*Response, error) {
	...
	if lid != nil {
		reqOpts = append(reqOpts, withPath(routeProjectsIDLabelsID, ProjectID{pid}, LabelID{lid}))
	} else {
		reqOpts = append(reqOpts, withPath(routeProjectsIDLabels, ProjectID{pid}))
	}
...
func (s *LabelsService) SubscribeToLabel(pid any, lid any, options ...RequestOptionFunc) (*Label, *Response, error) {
	return do[*Label](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDLabelsIDSubscribe, ProjectID{pid}, LabelID{lid}),
		withRequestOpts(options...),
	)
}
...
func (s *LabelsService) UnsubscribeFromLabel(pid any, lid any, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDLabelsIDUnsubscribe, ProjectID{pid}, LabelID{lid}),
		withRequestOpts(options...),
	)
	return resp, err
}
...
func (s *LabelsService) PromoteLabel(pid any, lid any, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		withMethod(http.MethodPut),
		withPath(routeProjectsIDLabelsIDPromote, ProjectID{pid}, LabelID{lid}),
		withRequestOpts(options...),
	)
	return resp, err
}
