...
var (
	routeGroupsIDIssues                         = route("groups/%s/issues")
	routeIssues                                 = route("issues")
	routeIssuesID                               = route("issues/%d")
	routeProjectsIDIssues                       = route("projects/%s/issues")
	routeProjectsIDIssuesID                     = route("projects/%s/issues/%d")
	routeProjectsIDIssuesIDClosedBy             = route("projects/%s/issues/%d/closed_by")
	routeProjectsIDIssuesIDMove                 = route("projects/%s/issues/%d/move")
	routeProjectsIDIssuesIDParticipants         = route("projects/%s/issues/%d/participants")
	routeProjectsIDIssuesIDRelatedMergeRequests = route("projects/%s/issues/%d/related_merge_requests")
	routeProjectsIDIssuesIDReorder              = route("projects/%s/issues/%d/reorder")
	routeProjectsIDIssuesIDSubscribe            = route("projects/%s/issues/%d/subscribe")
	routeProjectsIDIssuesIDTodo                 = route("projects/%s/issues/%d/todo")
	routeProjectsIDIssuesIDUnsubscribe          = route("projects/%s/issues/%d/unsubscribe")
)
...
func (s *IssuesService) ListGroupIssues(pid any, opt *ListGroupIssuesOptions, options ...RequestOptionFunc) ([]*Issue, *Response, error) {
	return do[[]*Issue](s.client,
		withPath(routeGroupsIDIssues, GroupID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *IssuesService) ReorderIssue(pid any, issue int64, opt *ReorderIssueOptions, options ...RequestOptionFunc) (*Issue, *Response, error) {
	return do[*Issue](s.client,
		withMethod(http.MethodPut),
		withPath(routeProjectsIDIssuesIDReorder, ProjectID{pid}, issue),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *IssuesService) MoveIssue(pid any, issue int64, opt *MoveIssueOptions, options ...RequestOptionFunc) (*Issue, *Response, error) {
	return do[*Issue](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDIssuesIDMove, ProjectID{pid}, issue),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *IssuesService) SubscribeToIssue(pid any, issue int64, options ...RequestOptionFunc) (*Issue, *Response, error) {
	return do[*Issue](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDIssuesIDSubscribe, ProjectID{pid}, issue),
		withRequestOpts(options...),
	)
}
...
func (s *IssuesService) UnsubscribeFromIssue(pid any, issue int64, options ...RequestOptionFunc) (*Issue, *Response, error) {
	return do[*Issue](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDIssuesIDUnsubscribe, ProjectID{pid}, issue),
		withRequestOpts(options...),
	)
}
...
func (s *IssuesService) CreateTodo(pid any, issue int64, options ...RequestOptionFunc) (*Todo, *Response, error) {
	return do[*Todo](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDIssuesIDTodo, ProjectID{pid}, issue),
		withRequestOpts(options...),
	)
}
...
func (s *IssuesService) ListMergeRequestsClosingIssue(pid any, issue int64, opt *ListMergeRequestsClosingIssueOptions, options ...RequestOptionFunc) ([]*BasicMergeRequest, *Response, error) {
	return do[[]*BasicMergeRequest](s.client,
		withPath(routeProjectsIDIssuesIDClosedBy, ProjectID{pid}, issue),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *IssuesService) ListMergeRequestsRelatedToIssue(pid any, issue int64, opt *ListMergeRequestsRelatedToIssueOptions, options ...RequestOptionFunc) ([]*BasicMergeRequest, *Response, error) {
	return do[[]*BasicMergeRequest](s.client,
		withPath(routeProjectsIDIssuesIDRelatedMergeRequests, ProjectID{pid}, issue),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *IssuesService) GetParticipants(pid any, issue int64, options ...RequestOptionFunc) ([]*BasicUser, *Response, error) {
	return do[[]*BasicUser](s.client,
		withPath(routeProjectsIDIssuesIDParticipants, ProjectID{pid}, issue),
		withRequestOpts(options...),
	)
}
