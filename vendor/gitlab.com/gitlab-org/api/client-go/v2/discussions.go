...
var (
	routeGroupsIDEpicsIDDiscussions                        = route("groups/%s/epics/%d/discussions")
	routeGroupsIDEpicsIDDiscussionsID                      = route("groups/%s/epics/%d/discussions/%s")
	routeGroupsIDEpicsIDDiscussionsIDNotes                 = route("groups/%s/epics/%d/discussions/%s/notes")
	routeGroupsIDEpicsIDDiscussionsIDNotesID               = route("groups/%s/epics/%d/discussions/%s/notes/%d")
	routeProjectsIDIssuesIDDiscussions                     = route("projects/%s/issues/%d/discussions")
	routeProjectsIDIssuesIDDiscussionsID                   = route("projects/%s/issues/%d/discussions/%s")
	routeProjectsIDIssuesIDDiscussionsIDNotes              = route("projects/%s/issues/%d/discussions/%s/notes")
	routeProjectsIDIssuesIDDiscussionsIDNotesID            = route("projects/%s/issues/%d/discussions/%s/notes/%d")
	routeProjectsIDMergeRequestsIDDiscussions              = route("projects/%s/merge_requests/%d/discussions")
	routeProjectsIDMergeRequestsIDDiscussionsID            = route("projects/%s/merge_requests/%d/discussions/%s")
	routeProjectsIDMergeRequestsIDDiscussionsIDNotes       = route("projects/%s/merge_requests/%d/discussions/%s/notes")
	routeProjectsIDMergeRequestsIDDiscussionsIDNotesID     = route("projects/%s/merge_requests/%d/discussions/%s/notes/%d")
	routeProjectsIDRepositoryCommitsIDDiscussions          = route("projects/%s/repository/commits/%s/discussions")
	routeProjectsIDRepositoryCommitsIDDiscussionsID        = route("projects/%s/repository/commits/%s/discussions/%s")
	routeProjectsIDRepositoryCommitsIDDiscussionsIDNotes   = route("projects/%s/repository/commits/%s/discussions/%s/notes")
	routeProjectsIDRepositoryCommitsIDDiscussionsIDNotesID = route("projects/%s/repository/commits/%s/discussions/%s/notes/%d")
	routeProjectsIDSnippetsIDDiscussions                   = route("projects/%s/snippets/%d/discussions")
	routeProjectsIDSnippetsIDDiscussionsID                 = route("projects/%s/snippets/%d/discussions/%s")
	routeProjectsIDSnippetsIDDiscussionsIDNotes            = route("projects/%s/snippets/%d/discussions/%s/notes")
	routeProjectsIDSnippetsIDDiscussionsIDNotesID          = route("projects/%s/snippets/%d/discussions/%s/notes/%d")
)
...
func (s *DiscussionsService) ListIssueDiscussions(pid any, issue int64, opt *ListIssueDiscussionsOptions, options ...RequestOptionFunc) ([]*Discussion, *Response, error) {
	return do[[]*Discussion](s.client,
		withPath(routeProjectsIDIssuesIDDiscussions, ProjectID{pid}, issue),
		withAPIOpts(opt),
...
func (s *DiscussionsService) GetIssueDiscussion(pid any, issue int64, discussion string, options ...RequestOptionFunc) (*Discussion, *Response, error) {
	return do[*Discussion](s.client,
		withPath(routeProjectsIDIssuesIDDiscussionsID, ProjectID{pid}, issue, discussion),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) AddIssueDiscussionNote(pid any, issue int64, discussion string, opt *AddIssueDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDIssuesIDDiscussionsIDNotes, ProjectID{pid}, issue, discussion),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) UpdateIssueDiscussionNote(pid any, issue int64, discussion string, note int64, opt *UpdateIssueDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		...
		withPath(routeProjectsIDIssuesIDDiscussionsIDNotesID, ProjectID{pid}, issue, discussion, note),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) ListSnippetDiscussions(pid any, snippet int64, opt *ListSnippetDiscussionsOptions, options ...RequestOptionFunc) ([]*Discussion, *Response, error) {
	return do[[]*Discussion](s.client,
		withPath(routeProjectsIDSnippetsIDDiscussions, ProjectID{pid}, snippet),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) GetSnippetDiscussion(pid any, snippet int64, discussion string, options ...RequestOptionFunc) (*Discussion, *Response, error) {
	return do[*Discussion](s.client,
		withPath(routeProjectsIDSnippetsIDDiscussionsID, ProjectID{pid}, snippet, discussion),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) AddSnippetDiscussionNote(pid any, snippet int64, discussion string, opt *AddSnippetDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDSnippetsIDDiscussionsIDNotes, ProjectID{pid}, snippet, discussion),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) UpdateSnippetDiscussionNote(pid any, snippet int64, discussion string, note int64, opt *UpdateSnippetDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withMethod(http.MethodPut),
		withPath(routeProjectsIDSnippetsIDDiscussionsIDNotesID, ProjectID{pid}, snippet, discussion, note),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) ListGroupEpicDiscussions(gid any, epic int64, opt *ListGroupEpicDiscussionsOptions, options ...RequestOptionFunc) ([]*Discussion, *Response, error) {
	return do[[]*Discussion](s.client,
		withPath(routeGroupsIDEpicsIDDiscussions, GroupID{gid}, epic),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) GetEpicDiscussion(gid any, epic int64, discussion string, options ...RequestOptionFunc) (*Discussion, *Response, error) {
	return do[*Discussion](s.client,
		withPath(routeGroupsIDEpicsIDDiscussionsID, GroupID{gid}, epic, discussion),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) AddEpicDiscussionNote(gid any, epic int64, discussion string, opt *AddEpicDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withMethod(http.MethodPost),
		withPath(routeGroupsIDEpicsIDDiscussionsIDNotes, GroupID{gid}, epic, discussion),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) UpdateEpicDiscussionNote(gid any, epic int64, discussion string, note int64, opt *UpdateEpicDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withMethod(http.MethodPut),
		withPath(routeGroupsIDEpicsIDDiscussionsIDNotesID, GroupID{gid}, epic, discussion, note),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) ListMergeRequestDiscussions(pid any, mergeRequest int64, opt *ListMergeRequestDiscussionsOptions, options ...RequestOptionFunc) ([]*Discussion, *Response, error) {
	return do[[]*Discussion](s.client,
		withPath(routeProjectsIDMergeRequestsIDDiscussions, ProjectID{pid}, mergeRequest),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) GetMergeRequestDiscussion(pid any, mergeRequest int64, discussion string, options ...RequestOptionFunc) (*Discussion, *Response, error) {
	return do[*Discussion](s.client,
		withPath(routeProjectsIDMergeRequestsIDDiscussionsID, ProjectID{pid}, mergeRequest, discussion),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) AddMergeRequestDiscussionNote(pid any, mergeRequest int64, discussion string, opt *AddMergeRequestDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDMergeRequestsIDDiscussionsIDNotes, ProjectID{pid}, mergeRequest, discussion),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) UpdateMergeRequestDiscussionNote(pid any, mergeRequest int64, discussion string, note int64, opt *UpdateMergeRequestDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withMethod(http.MethodPut),
		withPath(routeProjectsIDMergeRequestsIDDiscussionsIDNotesID, ProjectID{pid}, mergeRequest, discussion, note),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) ListCommitDiscussions(pid any, commit string, opt *ListCommitDiscussionsOptions, options ...RequestOptionFunc) ([]*Discussion, *Response, error) {
	return do[[]*Discussion](s.client,
		withPath(routeProjectsIDRepositoryCommitsIDDiscussions, ProjectID{pid}, commit),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) GetCommitDiscussion(pid any, commit string, discussion string, options ...RequestOptionFunc) (*Discussion, *Response, error) {
	return do[*Discussion](s.client,
		withPath(routeProjectsIDRepositoryCommitsIDDiscussionsID, ProjectID{pid}, commit, discussion),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) AddCommitDiscussionNote(pid any, commit string, discussion string, opt *AddCommitDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDRepositoryCommitsIDDiscussionsIDNotes, ProjectID{pid}, commit, discussion),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *DiscussionsService) UpdateCommitDiscussionNote(pid any, commit string, discussion string, note int64, opt *UpdateCommitDiscussionNoteOptions, options ...RequestOptionFunc) (*Note, *Response, error) {
	return do[*Note](s.client,
		withMethod(http.MethodPut),
		withPath(routeProjectsIDRepositoryCommitsIDDiscussionsIDNotesID, ProjectID{pid}, commit, discussion, note),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
