...
var (
	routeProjectsIDExternalStatusChecks                = route("projects/%s/external_status_checks")
	routeProjectsIDExternalStatusChecksID              = route("projects/%s/external_status_checks/%d")
	routeProjectsIDMergeRequestsIDStatusCheckResponses = route("projects/%s/merge_requests/%d/status_check_responses")
	routeProjectsIDMergeRequestsIDStatusChecks         = route("projects/%s/merge_requests/%d/status_checks")
	routeProjectsIDMergeRequestsIDStatusChecksIDRetry  = route("projects/%s/merge_requests/%d/status_checks/%d/retry")
)
...
func (s *ExternalStatusChecksService) ListMergeStatusChecks(pid any, mr int64, opt *ListOptions, options ...RequestOptionFunc) ([]*MergeStatusCheck, *Response, error) {
	return do[[]*MergeStatusCheck](s.client,
		withPath(routeProjectsIDMergeRequestsIDStatusChecks, ProjectID{pid}, mr),
		withAPIOpts(opt),
...
func (s *ExternalStatusChecksService) SetExternalStatusCheckStatus(pid any, mergeRequest int64, opt *SetExternalStatusCheckStatusOptions, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		...
		withPath(routeProjectsIDMergeRequestsIDStatusCheckResponses, ProjectID{pid}, mergeRequest),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	return resp, err
...
func (s *ExternalStatusChecksService) ListProjectStatusChecks(pid any, opt *ListOptions, options ...RequestOptionFunc) ([]*ProjectStatusCheck, *Response, error) {
	return do[[]*ProjectStatusCheck](s.client,
		withPath(routeProjectsIDExternalStatusChecks, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ExternalStatusChecksService) DeleteExternalStatusCheck(pid any, check int64, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		...
		withPath(routeProjectsIDExternalStatusChecksID, ProjectID{pid}, check),
		withRequestOpts(options...),
	)
	return resp, err
}
...
func (s *ExternalStatusChecksService) RetryFailedStatusCheckForAMergeRequest(pid any, mergeRequest int64, externalStatusCheck int64, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDMergeRequestsIDStatusChecksIDRetry, ProjectID{pid}, mergeRequest, externalStatusCheck),
		withRequestOpts(options...),
	)
	return resp, err
}
