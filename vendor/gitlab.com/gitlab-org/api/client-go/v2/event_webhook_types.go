...
type MergeEventObjectAttributes struct {
	...
	MergeError      string       `json:"merge_error"`
	MergeParams     *MergeParams `json:"merge_params"`
	// Deprecated: GitLab never emits the "merge_when_build_succeeds" key in
	// merge request webhooks, so this field is always false. Use
	// MergeWhenPipelineSucceeds instead.
