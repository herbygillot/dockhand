...
var (
	routeGroupsIDHooks                  = route("groups/%s/hooks")
	routeGroupsIDHooksID                = route("groups/%s/hooks/%d")
	routeGroupsIDHooksIDCustomHeadersID = route("groups/%s/hooks/%d/custom_headers/%s")
	routeGroupsIDHooksIDEventsIDResend  = route("groups/%s/hooks/%d/events/%d/resend")
	routeGroupsIDHooksIDTestID          = route("groups/%s/hooks/%d/test/%s")
	routeGroupsIDHooksIDUrlVariablesID  = route("groups/%s/hooks/%d/url_variables/%s")
)
...
func (s *GroupsService) ListGroupHooks(gid any, opt *ListGroupHooksOptions, options ...RequestOptionFunc) ([]*GroupHook, *Response, error) {
	return do[[]*GroupHook](
		s.client,
		withPath(routeGroupsIDHooks, GroupID{gid}),
		withAPIOpts(opt),
...
func (s *GroupsService) GetGroupHook(gid any, hook int64, options ...RequestOptionFunc) (*GroupHook, *Response, error) {
	return do[*GroupHook](
		s.client,
		withPath(routeGroupsIDHooksID, GroupID{gid}, hook),
		withRequestOpts(options...),
	)
}
...
func (s *GroupsService) ResendGroupHookEvent(gid any, hook int64, hookEventID int64, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](
		...
		withPath(routeGroupsIDHooksIDEventsIDResend, GroupID{gid}, hook, hookEventID),
		withRequestOpts(options...),
	)
	return resp, err
}
...
func (s *GroupsService) TriggerTestGroupHook(pid any, hook int64, trigger GroupHookTrigger, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeGroupsIDHooksIDTestID, GroupID{pid}, hook, NoEscape{string(trigger)}),
		withRequestOpts(options...),
	)
	return resp, err
}
...
func (s *GroupsService) SetGroupCustomHeader(gid any, hook int64, key string, opt *SetHookCustomHeaderOptions, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](
		s.client,
		withMethod(http.MethodPut),
		withPath(routeGroupsIDHooksIDCustomHeadersID, GroupID{gid}, hook, NoEscape{key}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	return resp, err
...
func (s *GroupsService) SetGroupHookURLVariable(gid any, hook int64, key string, opt *SetHookURLVariableOptions, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](
		s.client,
		withMethod(http.MethodPut),
		withPath(routeGroupsIDHooksIDUrlVariablesID, GroupID{gid}, hook, NoEscape{key}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	return resp, err
