...
var (
	routeGroupsIDServiceAccounts                               = route("groups/%s/service_accounts")
	routeGroupsIDServiceAccountsID                             = route("groups/%s/service_accounts/%d")
	routeGroupsIDServiceAccountsIDPersonalAccessTokens         = route("groups/%s/service_accounts/%d/personal_access_tokens")
	routeGroupsIDServiceAccountsIDPersonalAccessTokensID       = route("groups/%s/service_accounts/%d/personal_access_tokens/%d")
	routeGroupsIDServiceAccountsIDPersonalAccessTokensIDRotate = route("groups/%s/service_accounts/%d/personal_access_tokens/%d/rotate")
)
...
func (s *GroupsService) ListServiceAccounts(gid any, opt *ListServiceAccountsOptions, options ...RequestOptionFunc) ([]*GroupServiceAccount, *Response, error) {
	return do[[]*GroupServiceAccount](s.client,
		withPath(routeGroupsIDServiceAccounts, GroupID{gid}),
		withAPIOpts(opt),
...
func (s *GroupsService) ListServiceAccountPersonalAccessTokens(gid any, serviceAccount int64, opt *ListServiceAccountPersonalAccessTokensOptions, options ...RequestOptionFunc) ([]*PersonalAccessToken, *Response, error) {
	return do[[]*PersonalAccessToken](s.client,
		withPath(routeGroupsIDServiceAccountsIDPersonalAccessTokens, GroupID{gid}, serviceAccount),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *GroupsService) RevokeServiceAccountPersonalAccessToken(gid any, serviceAccount, token int64, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		withMethod(http.MethodDelete),
		withPath(routeGroupsIDServiceAccountsIDPersonalAccessTokensID, GroupID{gid}, serviceAccount, token),
		withRequestOpts(options...),
	)
	return resp, err
}
...
func (s *GroupsService) RotateServiceAccountPersonalAccessToken(gid any, serviceAccount, token int64, opt *RotateServiceAccountPersonalAccessTokenOptions, options ...RequestOptionFunc) (*PersonalAccessToken, *Response, error) {
	return do[*PersonalAccessToken](s.client,
		withMethod(http.MethodPost),
		withPath(routeGroupsIDServiceAccountsIDPersonalAccessTokensIDRotate, GroupID{gid}, serviceAccount, token),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
