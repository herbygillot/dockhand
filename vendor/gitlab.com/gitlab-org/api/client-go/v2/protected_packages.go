...
var (
	routeProjectsIDPackagesProtectionRules   = route("projects/%s/packages/protection/rules")
	routeProjectsIDPackagesProtectionRulesID = route("projects/%s/packages/protection/rules/%d")
)
...
func (s *ProtectedPackagesService) ListPackageProtectionRules(pid any, opts *ListPackageProtectionRulesOptions, options ...RequestOptionFunc) ([]*PackageProtectionRule, *Response, error) {
	return do[[]*PackageProtectionRule](s.client,
		withPath(routeProjectsIDPackagesProtectionRules, ProjectID{pid}),
		withAPIOpts(opts),
...
func (s *ProtectedPackagesService) DeletePackageProtectionRules(pid any, packageProtectionRule int64, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		...
		withPath(routeProjectsIDPackagesProtectionRulesID, ProjectID{pid}, packageProtectionRule),
		withRequestOpts(options...),
	)
	return resp, err
}
