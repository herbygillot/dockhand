...
var (
	routeSnippets               = route("snippets")
	routeSnippetsAll            = route("snippets/all")
	routeSnippetsID             = route("snippets/%d")
	routeSnippetsIDFilesIDIDRaw = route("snippets/%d/files/%s/%s/raw")
	routeSnippetsIDRaw          = route("snippets/%d/raw")
	routeSnippetsPublic         = route("snippets/public")
)
...
func (s *SnippetsService) GetSnippet(snippet int64, options ...RequestOptionFunc) (*Snippet, *Response, error) {
	res, resp, err := do[*Snippet](s.client,
		withMethod(http.MethodGet),
		withPath(routeSnippetsID, snippet),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
	if err != nil {
...
func (s *SnippetsService) SnippetContent(snippet int64, options ...RequestOptionFunc) ([]byte, *Response, error) {
	buf, resp, err := do[bytes.Buffer](s.client,
		withPath(routeSnippetsIDRaw, snippet),
		withRequestOpts(options...),
	)
	if err != nil {
		return nil, resp, err
...
func (s *SnippetsService) SnippetFileContent(snippet int64, ref, filename string, options ...RequestOptionFunc) ([]byte, *Response, error) {
	buf, resp, err := do[bytes.Buffer](s.client,
		withPath(routeSnippetsIDFilesIDIDRaw, snippet, ref, filename),
		withRequestOpts(options...),
	)
	if err != nil {
		return nil, resp, err
