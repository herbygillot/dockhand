...
var (
	...
	routeProjectsIDApprovalRules    = route("projects/%s/approval_rules")
	routeProjectsIDApprovalRulesID  = route("projects/%s/approval_rules/%d")
	routeProjectsIDApprovals        = route("projects/%s/approvals")
	routeProjectsIDArchive          = route("projects/%s/archive")
	routeProjectsIDAvatar           = route("projects/%s/avatar")
	routeProjectsIDFork             = route("projects/%s/fork")
	routeProjectsIDForkID           = route("projects/%s/fork/%d")
	routeProjectsIDForks            = route("projects/%s/forks")
	routeProjectsIDGroups           = route("projects/%s/groups")
	routeProjectsIDHousekeeping     = route("projects/%s/housekeeping")
	routeProjectsIDInvitedGroups    = route("projects/%s/invited_groups")
	routeProjectsIDLanguages        = route("projects/%s/languages")
	routeProjectsIDMirrorPull       = route("projects/%s/mirror/pull")
	routeProjectsIDPushRule         = route("projects/%s/push_rule")
	routeProjectsIDRestore          = route("projects/%s/restore")
	routeProjectsIDShare            = route("projects/%s/share")
	routeProjectsIDShareID          = route("projects/%s/share/%d")
	routeProjectsIDStar             = route("projects/%s/star")
	routeProjectsIDStarrers         = route("projects/%s/starrers")
	routeProjectsIDStorage          = route("projects/%s/storage")
	routeProjectsIDTransfer         = route("projects/%s/transfer")
	routeProjectsIDUnarchive        = route("projects/%s/unarchive")
	routeProjectsIDUnstar           = route("projects/%s/unstar")
	routeProjectsIDUsers            = route("projects/%s/users")
	routeProjectsUserID             = route("projects/user/%d")
	routeUsersIDContributedProjects = route("users/%s/contributed_projects")
	routeUsersIDProjects            = route("users/%s/projects")
	routeUsersIDStarredProjects     = route("users/%s/starred_projects")
)
...
type Project struct {
	...
	MRDefaultTitleTemplate                    string                                      `json:"mr_default_title_template"`
...
type ListProjectsOptions struct {
	...
	// CustomAttributes filters projects by custom attributes, producing query
...
func (s *ProjectsService) ListUserProjects(uid any, opt *ListProjectsOptions, options ...RequestOptionFunc) ([]*Project, *Response, error) {
	return do[[]*Project](
		s.client,
		withPath(routeUsersIDProjects, UserID{uid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) ListUserContributedProjects(uid any, opt *ListProjectsOptions, options ...RequestOptionFunc) ([]*Project, *Response, error) {
	return do[[]*Project](
		s.client,
		withPath(routeUsersIDContributedProjects, UserID{uid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) ListUserStarredProjects(uid any, opt *ListProjectsOptions, options ...RequestOptionFunc) ([]*Project, *Response, error) {
	return do[[]*Project](
		s.client,
		withPath(routeUsersIDStarredProjects, UserID{uid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) ListProjectsUsers(pid any, opt *ListProjectUserOptions, options ...RequestOptionFunc) ([]*ProjectUser, *Response, error) {
	return do[[]*ProjectUser](
		s.client,
		withPath(routeProjectsIDUsers, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) ListProjectsGroups(pid any, opt *ListProjectGroupOptions, options ...RequestOptionFunc) ([]*ProjectGroup, *Response, error) {
	return do[[]*ProjectGroup](
		s.client,
		withPath(routeProjectsIDGroups, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) GetProjectLanguages(pid any, options ...RequestOptionFunc) (*ProjectLanguages, *Response, error) {
	return do[*ProjectLanguages](
		s.client,
		withPath(routeProjectsIDLanguages, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) GetProject(pid any, opt *GetProjectOptions, options ...RequestOptionFunc) (*Project, *Response, error) {
	return do[*Project](
		s.client,
		withPath(routeProjectsID, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
type CreateProjectOptions struct {
	...
	CICDCatalogEnabled                        *bool                                `url:"cicd_catalog_enabled,omitempty" json:"cicd_catalog_enabled,omitempty"`
	...
	MRDefaultTitleTemplate                    *string                              `url:"mr_default_title_template,omitempty" json:"mr_default_title_template,omitempty"`
	// Deprecated: Use PackageRegistryAccessLevel instead.
...
func (s *ProjectsService) CreateProjectForUser(user int64, opt *CreateProjectForUserOptions, options ...RequestOptionFunc) (*Project, *Response, error) {
	...
	reqOpts := []doOption{
		withMethod(http.MethodPost),
		withPath(routeProjectsUserID, user),
		withAPIOpts(opt),
		withRequestOpts(options...),
	}
	if opt.Avatar != nil {
...
func (s *ProjectsService) ForkProject(pid any, opt *ForkProjectOptions, options ...RequestOptionFunc) (*Project, *Response, error) {
	return do[*Project](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDFork, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) StarProject(pid any, options ...RequestOptionFunc) (*Project, *Response, error) {
	return do[*Project](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDStar, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) ListProjectsInvitedGroups(pid any, opt *ListProjectInvitedGroupOptions, options ...RequestOptionFunc) ([]*ProjectGroup, *Response, error) {
	return do[[]*ProjectGroup](
		s.client,
		withPath(routeProjectsIDInvitedGroups, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) UnstarProject(pid any, options ...RequestOptionFunc) (*Project, *Response, error) {
	return do[*Project](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDUnstar, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) ArchiveProject(pid any, options ...RequestOptionFunc) (*Project, *Response, error) {
	return do[*Project](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDArchive, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) UnarchiveProject(pid any, options ...RequestOptionFunc) (*Project, *Response, error) {
	return do[*Project](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDUnarchive, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) RestoreProject(pid any, options ...RequestOptionFunc) (*Project, *Response, error) {
	return do[*Project](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDRestore, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) ShareProjectWithGroup(pid any, opt *ShareWithGroupOptions, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDShare, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	return resp, err
...
func (s *ProjectsService) DeleteSharedProjectFromGroup(pid any, groupID int64, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](
		s.client,
		withMethod(http.MethodDelete),
		withPath(routeProjectsIDShareID, ProjectID{pid}, groupID),
		withRequestOpts(options...),
	)
	return resp, err
}
...
func (s *ProjectsService) CreateProjectForkRelation(pid any, fork int64, options ...RequestOptionFunc) (*ProjectForkRelation, *Response, error) {
	return do[*ProjectForkRelation](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDForkID, ProjectID{pid}, fork),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) DownloadAvatar(pid any, options ...RequestOptionFunc) (*bytes.Reader, *Response, error) {
	buf, resp, err := do[bytes.Buffer](
		s.client,
		withPath(routeProjectsIDAvatar, ProjectID{pid}),
		withRequestOpts(options...),
	)
	if err != nil {
		return nil, resp, err
...
func (s *ProjectsService) ListProjectForks(pid any, opt *ListProjectsOptions, options ...RequestOptionFunc) ([]*Project, *Response, error) {
	return do[[]*Project](
		s.client,
		withPath(routeProjectsIDForks, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) GetProjectPushRules(pid any, options ...RequestOptionFunc) (*ProjectPushRules, *Response, error) {
	return do[*ProjectPushRules](
		s.client,
		withPath(routeProjectsIDPushRule, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) GetApprovalConfiguration(pid any, options ...RequestOptionFunc) (*ProjectApprovals, *Response, error) {
	return do[*ProjectApprovals](
		s.client,
		withPath(routeProjectsIDApprovals, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) GetProjectApprovalRules(pid any, opt *GetProjectApprovalRulesListsOptions, options ...RequestOptionFunc) ([]*ProjectApprovalRule, *Response, error) {
	return do[[]*ProjectApprovalRule](
		s.client,
		withPath(routeProjectsIDApprovalRules, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) GetProjectApprovalRule(pid any, ruleID int64, options ...RequestOptionFunc) (*ProjectApprovalRule, *Response, error) {
	return do[*ProjectApprovalRule](
		s.client,
		withPath(routeProjectsIDApprovalRulesID, ProjectID{pid}, ruleID),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) UpdateProjectApprovalRule(pid any, approvalRule int64, opt *UpdateProjectLevelRuleOptions, options ...RequestOptionFunc) (*ProjectApprovalRule, *Response, error) {
	return do[*ProjectApprovalRule](
		s.client,
		withMethod(http.MethodPut),
		withPath(routeProjectsIDApprovalRulesID, ProjectID{pid}, approvalRule),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) GetProjectPullMirrorDetails(pid any, options ...RequestOptionFunc) (*ProjectPullMirrorDetails, *Response, error) {
	return do[*ProjectPullMirrorDetails](
		s.client,
		withPath(routeProjectsIDMirrorPull, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) TransferProject(pid any, opt *TransferProjectOptions, options ...RequestOptionFunc) (*Project, *Response, error) {
	return do[*Project](
		s.client,
		withMethod(http.MethodPut),
		withPath(routeProjectsIDTransfer, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) StartHousekeepingProject(pid any, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](
		s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDHousekeeping, ProjectID{pid}),
		withRequestOpts(options...),
	)
	return resp, err
}
...
func (s *ProjectsService) GetRepositoryStorage(pid any, options ...RequestOptionFunc) (*ProjectRepositoryStorage, *Response, error) {
	return do[*ProjectRepositoryStorage](
		s.client,
		withPath(routeProjectsIDStorage, ProjectID{pid}),
		withRequestOpts(options...),
	)
}
...
func (s *ProjectsService) ListProjectStarrers(pid any, opts *ListProjectStarrersOptions, options ...RequestOptionFunc) ([]*ProjectStarrer, *Response, error) {
	return do[[]*ProjectStarrer](
		s.client,
		withPath(routeProjectsIDStarrers, ProjectID{pid}),
		withAPIOpts(opts),
		withRequestOpts(options...),
	)
}
