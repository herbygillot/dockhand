...
var routeProjectsIDMergeRequestsIDContextCommits = route("projects/%s/merge_requests/%d/context_commits")
...
func (s *MergeRequestContextCommitsService) ListMergeRequestContextCommits(pid any, mergeRequest int64, options ...RequestOptionFunc) ([]*Commit, *Response, error) {
	return do[[]*Commit](s.client,
		withPath(routeProjectsIDMergeRequestsIDContextCommits, ProjectID{pid}, mergeRequest),
