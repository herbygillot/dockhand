...
var (
	routeGroupsIDIntegrationsDatadog                 = route("groups/%s/integrations/datadog")
	routeGroupsIDIntegrationsMattermost              = route("groups/%s/integrations/mattermost")
	routeGroupsIDIntegrationsMattermostSlashCommands = route("groups/%s/integrations/mattermost-slash-commands")
)
...
func (s *IntegrationsService) GetGroupMattermostSlashCommandsIntegration(gid any, options ...RequestOptionFunc) (*GroupMattermostSlashCommandsIntegration, *Response, error) {
	return do[*GroupMattermostSlashCommandsIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsMattermostSlashCommands, GroupID{gid}),
		withMethod(http.MethodGet),
		withRequestOpts(options...),
	)
}
...
func (s *IntegrationsService) GetGroupDatadogIntegration(gid any, options ...RequestOptionFunc) (*GroupDatadogIntegration, *Response, error) {
	return do[*GroupDatadogIntegration](
		s.client,
		withPath(routeGroupsIDIntegrationsDatadog, GroupID{gid}),
		withMethod(http.MethodGet),
		withRequestOpts(options...),
	)
}
