...
var (
	routeProjectsIDMergeRequestsIDDraftNotes            = route("projects/%s/merge_requests/%d/draft_notes")
	routeProjectsIDMergeRequestsIDDraftNotesBulkPublish = route("projects/%s/merge_requests/%d/draft_notes/bulk_publish")
	routeProjectsIDMergeRequestsIDDraftNotesID          = route("projects/%s/merge_requests/%d/draft_notes/%d")
	routeProjectsIDMergeRequestsIDDraftNotesIDPublish   = route("projects/%s/merge_requests/%d/draft_notes/%d/publish")
)
...
func (s *DraftNotesService) ListDraftNotes(pid any, mergeRequest int64, opt *ListDraftNotesOptions, options ...RequestOptionFunc) ([]*DraftNote, *Response, error) {
	return do[[]*DraftNote](s.client,
		withPath(routeProjectsIDMergeRequestsIDDraftNotes, ProjectID{pid}, mergeRequest),
		withAPIOpts(opt),
...
func (s *DraftNotesService) GetDraftNote(pid any, mergeRequest int64, note int64, options ...RequestOptionFunc) (*DraftNote, *Response, error) {
	return do[*DraftNote](s.client,
		withPath(routeProjectsIDMergeRequestsIDDraftNotesID, ProjectID{pid}, mergeRequest, note),
		withRequestOpts(options...),
	)
}
...
func (s *DraftNotesService) PublishDraftNote(pid any, mergeRequest int64, note int64, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		withMethod(http.MethodPut),
		withPath(routeProjectsIDMergeRequestsIDDraftNotesIDPublish, ProjectID{pid}, mergeRequest, note),
		withRequestOpts(options...),
	)
	return resp, err
}
