...
type Client struct {
	...
	Achievements                        AchievementsServiceInterface
	...
	ContainerRegistryTagProtectionRules ContainerRegistryTagProtectionRulesServiceInterface
	...
	SecurityDependencyFirewall          SecurityDependencyFirewallServiceInterface
	...
	WorkItemSavedViews                  WorkItemSavedViewsServiceInterface
...
func NewAuthSourceClient(as AuthSource, options ...ClientOptionFunc) (*Client, error) {
	...
	c.Achievements = &AchievementsService{client: c}
	...
	c.ContainerRegistryTagProtectionRules = &ContainerRegistryTagProtectionRulesService{client: c}
	...
	c.SecurityDependencyFirewall = &SecurityDependencyFirewallService{client: c}
	...
	c.WorkItemSavedViews = &WorkItemSavedViewsService{client: c}
