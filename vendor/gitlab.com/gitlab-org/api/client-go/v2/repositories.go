...
var (
	routeProjectsIDRepositoryArchiveFormat = route("projects/%s/repository/archive%s")
	routeProjectsIDRepositoryBlobsID       = route("projects/%s/repository/blobs/%s")
	routeProjectsIDRepositoryBlobsIDRaw    = route("projects/%s/repository/blobs/%s/raw")
	routeProjectsIDRepositoryChangelog     = route("projects/%s/repository/changelog")
	routeProjectsIDRepositoryCompare       = route("projects/%s/repository/compare")
	routeProjectsIDRepositoryContributors  = route("projects/%s/repository/contributors")
	routeProjectsIDRepositoryMergeBase     = route("projects/%s/repository/merge_base")
	routeProjectsIDRepositoryTree          = route("projects/%s/repository/tree")
)
...
func (s *RepositoriesService) ListTree(pid any, opt *ListTreeOptions, options ...RequestOptionFunc) ([]*TreeNode, *Response, error) {
	return do[[]*TreeNode](s.client,
		withPath(routeProjectsIDRepositoryTree, ProjectID{pid}),
		withAPIOpts(opt),
...
func (s *RepositoriesService) Blob(pid any, sha string, options ...RequestOptionFunc) ([]byte, *Response, error) {
	buf, resp, err := do[bytes.Buffer](s.client,
		withPath(routeProjectsIDRepositoryBlobsID, ProjectID{pid}, sha),
		withRequestOpts(options...),
	)
	if err != nil {
		return nil, resp, err
...
func (s *RepositoriesService) RawBlobContent(pid any, sha string, options ...RequestOptionFunc) ([]byte, *Response, error) {
	buf, resp, err := do[bytes.Buffer](s.client,
		withPath(routeProjectsIDRepositoryBlobsIDRaw, ProjectID{pid}, sha),
		withRequestOpts(options...),
	)
	if err != nil {
		return nil, resp, err
...
func (s *RepositoriesService) Archive(pid any, opt *ArchiveOptions, options ...RequestOptionFunc) ([]byte, *Response, error) {
	...
	buf, resp, err := do[bytes.Buffer](s.client,
		withPath(routeProjectsIDRepositoryArchiveFormat, ProjectID{pid}, NoEscape{suffix}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	if err != nil {
...
func (s *RepositoriesService) Compare(pid any, opt *CompareOptions, options ...RequestOptionFunc) (*Compare, *Response, error) {
	return do[*Compare](s.client,
		withPath(routeProjectsIDRepositoryCompare, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *RepositoriesService) Contributors(pid any, opt *ListContributorsOptions, options ...RequestOptionFunc) ([]*Contributor, *Response, error) {
	return do[[]*Contributor](s.client,
		withPath(routeProjectsIDRepositoryContributors, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *RepositoriesService) MergeBase(pid any, opt *MergeBaseOptions, options ...RequestOptionFunc) (*Commit, *Response, error) {
	return do[*Commit](s.client,
		withPath(routeProjectsIDRepositoryMergeBase, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *RepositoriesService) AddChangelog(pid any, opt *AddChangelogOptions, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		...
		withPath(routeProjectsIDRepositoryChangelog, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	return resp, err
