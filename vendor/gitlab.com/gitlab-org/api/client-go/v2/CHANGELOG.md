...
- feat: support achievements CRUD operations ([!2962](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/2962)) by [BoxBoxJason](https://gitlab.com/BoxBoxJason)

### 🔄 Other Changes

- chore(deps): update module github.com/google/cel-go to v0.32.0 ([!3010](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3010)) by [GitLab Dependency Bot](https://gitlab.com/gitlab-dependency-update-bot)
- chore(deps): update docker docker tag to v29.8.0 ([!3024](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3024)) by [GitLab Dependency Bot](https://gitlab.com/gitlab-dependency-update-bot)



# [2.64.0](https://gitlab.com/gitlab-org/api/client-go/compare/v2.63.0...v2.64.0) (2026-09-05)


### Features

* support achievements CRUD operations ([c292954](https://gitlab.com/gitlab-org/api/client-go/commit/c292954a3d48eafd3b99516e348bbfe29b834a73))

## 2.63.0

### 🚀 Features

- feat: register API routes and expose Routes and MatchRoute ([!3023](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3023)) by [Kai Armstrong](https://gitlab.com/phikai)

### 🔄 Other Changes

- chore(deps): update module buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go to v1.36.12-20260825204119-511051f7f437.2 ([!3021](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3021)) by [GitLab Dependency Bot](https://gitlab.com/gitlab-dependency-update-bot)
- chore(deps): update dependency golangci-lint to v2.13.2 ([!3022](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3022)) by [GitLab Dependency Bot](https://gitlab.com/gitlab-dependency-update-bot)



# [2.63.0](https://gitlab.com/gitlab-org/api/client-go/compare/v2.62.0...v2.63.0) (2026-09-04)


### Features

* add an API route registry with Routes and MatchRoute ([ba606c7](https://gitlab.com/gitlab-org/api/client-go/commit/ba606c78b1567bd37f22bd6ec27fd4425a932c7c))

## 2.62.0

### 🚀 Features

- #2257 Add Work Item Saved Views API support ([!2947](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/2947)) by [Sina Moghaddas](https://gitlab.com/SinaMoghaddas)

### 🔄 Other Changes

- chore(deps): update module buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go to v1.36.12-20260825204119-511051f7f437.1 ([!3020](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3020)) by [GitLab Dependency Bot](https://gitlab.com/gitlab-dependency-update-bot)
- chore(deps): update module golang.org/x/text to v0.41.0 ([!3018](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3018)) by [GitLab Dependency Bot](https://gitlab.com/gitlab-dependency-update-bot)



# [2.62.0](https://gitlab.com/gitlab-org/api/client-go/compare/v2.61.0...v2.62.0) (2026-09-02)

## 2.61.0

### 🚀 Features

- feat: add Dependency Firewall ecosystems (composer, conan, golang, nuget, cargo, swift, pub) ([!3016](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3016)) by [Michael Eddington](https://gitlab.com/mikeeddington)

### 🔄 Other Changes

- fix: satisfy golangci-lint 2.13.1 ([!3017](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3017)) by [Michael Eddington](https://gitlab.com/mikeeddington)
- chore(deps): update dependency golangci-lint to v2.13.1 ([!3012](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3012)) by [GitLab Dependency Bot](https://gitlab.com/gitlab-dependency-update-bot)
- chore(deps): update dependency golangci-lint to v2.13.0 ([!3011](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/3011)) by [GitLab Dependency Bot](https://gitlab.com/gitlab-dependency-update-bot)



# [2.61.0](https://gitlab.com/gitlab-org/api/client-go/compare/v2.60.0...v2.61.0) (2026-08-31)


### Bug Fixes

* satisfy golangci-lint 2.13.1 ([6ed574d](https://gitlab.com/gitlab-org/api/client-go/commit/6ed574d9ac600f05dfa404e668a3118c6a82c87e))


### Features

* add Dependency Firewall ecosystems (composer, conan, golang, nuget, cargo, swift, pub) ([7cd7b90](https://gitlab.com/gitlab-org/api/client-go/commit/7cd7b90d024a29e98170538a50c1fdd729eb43b0))

## 2.60.0

### 🚀 Features

- feat: add Dependency Firewall package evaluation endpoint ([!2998](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/2998)) by [Michael Eddington](https://gitlab.com/mikeeddington)



# [2.60.0](https://gitlab.com/gitlab-org/api/client-go/compare/v2.59.1...v2.60.0) (2026-08-26)


### Features

* add Dependency Firewall package evaluation endpoint ([b76c955](https://gitlab.com/gitlab-org/api/client-go/commit/b76c955703a6f55778b592c75a134b5a9992bfd7))
...
- fix: handle pkg registry filename slashes ([!2989](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/2989)) by [Giannis Kepas](https://gitlab.com/gkepas)

### 🔄 Other Changes

- Temporarily disable integration tests ([!2997](https://gitlab.com/gitlab-org/api/client-go/-/merge_requests/2997)) by [Patrick Rice](https://gitlab.com/PatrickRice)



## [2.58.2](https://gitlab.com/gitlab-org/api/client-go/compare/v2.58.1...v2.58.2) (2026-08-21)


### Bug Fixes

* handle pkg registry filename slashes ([49ef9f5](https://gitlab.com/gitlab-org/api/client-go/commit/49ef9f53642714269c9bb747f14fa90f426d8385))
