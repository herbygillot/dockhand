...
var (
	routeProjectsIDAlertManagementAlertsIDMetricImages   = route("projects/%s/alert_management_alerts/%d/metric_images")
	routeProjectsIDAlertManagementAlertsIDMetricImagesID = route("projects/%s/alert_management_alerts/%d/metric_images/%d")
)
...
func (s *AlertManagementService) UploadMetricImage(pid any, alertIID int64, content io.Reader, filename string, opt *UploadMetricImageOptions, options ...RequestOptionFunc) (*MetricImage, *Response, error) {
	return do[*MetricImage](s.client,
		...
		withPath(routeProjectsIDAlertManagementAlertsIDMetricImages, ProjectID{pid}, alertIID),
...
func (s *AlertManagementService) UpdateMetricImage(pid any, alertIID int64, id int64, opt *UpdateMetricImageOptions, options ...RequestOptionFunc) (*MetricImage, *Response, error) {
	return do[*MetricImage](s.client,
		...
		withPath(routeProjectsIDAlertManagementAlertsIDMetricImagesID, ProjectID{pid}, alertIID, id),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
