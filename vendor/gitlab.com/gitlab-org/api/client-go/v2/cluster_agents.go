...
var (
	routeProjectsIDClusterAgents           = route("projects/%s/cluster_agents")
	routeProjectsIDClusterAgentsID         = route("projects/%s/cluster_agents/%d")
	routeProjectsIDClusterAgentsIDTokens   = route("projects/%s/cluster_agents/%d/tokens")
	routeProjectsIDClusterAgentsIDTokensID = route("projects/%s/cluster_agents/%d/tokens/%d")
)
...
func (s *ClusterAgentsService) ListAgents(pid any, opt *ListAgentsOptions, options ...RequestOptionFunc) ([]*Agent, *Response, error) {
	return do[[]*Agent](s.client,
		withPath(routeProjectsIDClusterAgents, ProjectID{pid}),
		withAPIOpts(opt),
...
func (s *ClusterAgentsService) GetAgent(pid any, id int64, options ...RequestOptionFunc) (*Agent, *Response, error) {
	return do[*Agent](s.client,
		withPath(routeProjectsIDClusterAgentsID, ProjectID{pid}, id),
		withRequestOpts(options...),
	)
}
...
func (s *ClusterAgentsService) ListAgentTokens(pid any, aid int64, opt *ListAgentTokensOptions, options ...RequestOptionFunc) ([]*AgentToken, *Response, error) {
	return do[[]*AgentToken](s.client,
		...
		withPath(routeProjectsIDClusterAgentsIDTokens, ProjectID{pid}, aid),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ClusterAgentsService) GetAgentToken(pid any, aid int64, id int64, options ...RequestOptionFunc) (*AgentToken, *Response, error) {
	return do[*AgentToken](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDClusterAgentsIDTokensID, ProjectID{pid}, aid, id),
		withRequestOpts(options...),
	)
}
