...
var (
	routeGroupsIDEpicsIDResourceLabelEvents             = route("groups/%s/epics/%d/resource_label_events")
	routeGroupsIDEpicsIDResourceLabelEventsID           = route("groups/%s/epics/%d/resource_label_events/%d")
	routeProjectsIDIssuesIDResourceLabelEvents          = route("projects/%s/issues/%d/resource_label_events")
	routeProjectsIDIssuesIDResourceLabelEventsID        = route("projects/%s/issues/%d/resource_label_events/%d")
	routeProjectsIDMergeRequestsIDResourceLabelEvents   = route("projects/%s/merge_requests/%d/resource_label_events")
	routeProjectsIDMergeRequestsIDResourceLabelEventsID = route("projects/%s/merge_requests/%d/resource_label_events/%d")
)
...
func (s *ResourceLabelEventsService) ListIssueLabelEvents(pid any, issue int64, opt *ListLabelEventsOptions, options ...RequestOptionFunc) ([]*LabelEvent, *Response, error) {
	return do[[]*LabelEvent](s.client,
		withPath(routeProjectsIDIssuesIDResourceLabelEvents, ProjectID{pid}, issue),
		withAPIOpts(opt),
...
func (s *ResourceLabelEventsService) GetIssueLabelEvent(pid any, issue int64, event int64, options ...RequestOptionFunc) (*LabelEvent, *Response, error) {
	return do[*LabelEvent](s.client,
		withPath(routeProjectsIDIssuesIDResourceLabelEventsID, ProjectID{pid}, issue, event),
		withRequestOpts(options...),
	)
}
...
func (s *ResourceLabelEventsService) ListGroupEpicLabelEvents(gid any, epic int64, opt *ListLabelEventsOptions, options ...RequestOptionFunc) ([]*LabelEvent, *Response, error) {
	return do[[]*LabelEvent](s.client,
		withPath(routeGroupsIDEpicsIDResourceLabelEvents, GroupID{gid}, epic),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ResourceLabelEventsService) GetGroupEpicLabelEvent(gid any, epic int64, event int64, options ...RequestOptionFunc) (*LabelEvent, *Response, error) {
	return do[*LabelEvent](s.client,
		withPath(routeGroupsIDEpicsIDResourceLabelEventsID, GroupID{gid}, epic, event),
		withRequestOpts(options...),
	)
}
...
func (s *ResourceLabelEventsService) ListMergeRequestsLabelEvents(pid any, request int64, opt *ListLabelEventsOptions, options ...RequestOptionFunc) ([]*LabelEvent, *Response, error) {
	return do[[]*LabelEvent](s.client,
		withPath(routeProjectsIDMergeRequestsIDResourceLabelEvents, ProjectID{pid}, request),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
}
...
func (s *ResourceLabelEventsService) GetMergeRequestLabelEvent(pid any, request int64, event int64, options ...RequestOptionFunc) (*LabelEvent, *Response, error) {
	return do[*LabelEvent](s.client,
		withPath(routeProjectsIDMergeRequestsIDResourceLabelEventsID, ProjectID{pid}, request, event),
		withRequestOpts(options...),
	)
}
