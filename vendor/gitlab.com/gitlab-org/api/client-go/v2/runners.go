...
var (
	routeGroupsIDRunners                         = route("groups/%s/runners")
	routeGroupsIDRunnersResetRegistrationToken   = route("groups/%s/runners/reset_registration_token")
	routeProjectsIDRunners                       = route("projects/%s/runners")
	routeProjectsIDRunnersID                     = route("projects/%s/runners/%d")
	routeProjectsIDRunnersResetRegistrationToken = route("projects/%s/runners/reset_registration_token")
	routeRunners                                 = route("runners")
	routeRunnersAll                              = route("runners/all")
	routeRunnersID                               = route("runners/%s")
	routeRunnersIDJobs                           = route("runners/%s/jobs")
	routeRunnersIDManagers                       = route("runners/%s/managers")
	routeRunnersIDResetAuthenticationToken       = route("runners/%d/reset_authentication_token")
	routeRunnersResetRegistrationToken           = route("runners/reset_registration_token")
	routeRunnersVerify                           = route("runners/verify")
)
...
func (s *RunnersService) GetRunnerDetails(rid any, options ...RequestOptionFunc) (*RunnerDetails, *Response, error) {
	res, resp, err := do[*RunnerDetails](s.client,
		withMethod(http.MethodGet),
		withPath(routeRunnersID, RunnerID{rid}),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
	if err != nil {
...
func (s *RunnersService) ListRunnerJobs(rid any, opt *ListRunnerJobsOptions, options ...RequestOptionFunc) ([]*Job, *Response, error) {
	res, resp, err := do[[]*Job](s.client,
		withMethod(http.MethodGet),
		withPath(routeRunnersIDJobs, RunnerID{rid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	if err != nil {
...
func (s *RunnersService) ListRunnerManagers(rid any, options ...RequestOptionFunc) ([]*RunnerManager, *Response, error) {
	res, resp, err := do[[]*RunnerManager](s.client,
		withMethod(http.MethodGet),
		withPath(routeRunnersIDManagers, RunnerID{rid}),
		withRequestOpts(options...),
	)
	if err != nil {
		return nil, resp, err
...
func (s *RunnersService) ListProjectRunners(pid any, opt *ListProjectRunnersOptions, options ...RequestOptionFunc) ([]*Runner, *Response, error) {
	res, resp, err := do[[]*Runner](s.client,
		withMethod(http.MethodGet),
		withPath(routeProjectsIDRunners, ProjectID{pid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	if err != nil {
...
func (s *RunnersService) DisableProjectRunner(pid any, runner int64, options ...RequestOptionFunc) (*Response, error) {
	_, resp, err := do[none](s.client,
		withMethod(http.MethodDelete),
		withPath(routeProjectsIDRunnersID, ProjectID{pid}, runner),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
	return resp, err
...
func (s *RunnersService) ListGroupsRunners(gid any, opt *ListGroupsRunnersOptions, options ...RequestOptionFunc) ([]*Runner, *Response, error) {
	res, resp, err := do[[]*Runner](s.client,
		withMethod(http.MethodGet),
		withPath(routeGroupsIDRunners, GroupID{gid}),
		withAPIOpts(opt),
		withRequestOpts(options...),
	)
	if err != nil {
...
func (s *RunnersService) ResetInstanceRunnerRegistrationToken(options ...RequestOptionFunc) (*RunnerRegistrationToken, *Response, error) {
	res, resp, err := do[*RunnerRegistrationToken](s.client,
		withMethod(http.MethodPost),
		withPath(routeRunnersResetRegistrationToken),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
	if err != nil {
...
func (s *RunnersService) ResetGroupRunnerRegistrationToken(gid any, options ...RequestOptionFunc) (*RunnerRegistrationToken, *Response, error) {
	res, resp, err := do[*RunnerRegistrationToken](s.client,
		withMethod(http.MethodPost),
		withPath(routeGroupsIDRunnersResetRegistrationToken, GroupID{gid}),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
	if err != nil {
...
func (s *RunnersService) ResetProjectRunnerRegistrationToken(pid any, options ...RequestOptionFunc) (*RunnerRegistrationToken, *Response, error) {
	res, resp, err := do[*RunnerRegistrationToken](s.client,
		withMethod(http.MethodPost),
		withPath(routeProjectsIDRunnersResetRegistrationToken, ProjectID{pid}),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
	if err != nil {
...
func (s *RunnersService) ResetRunnerAuthenticationToken(rid int64, options ...RequestOptionFunc) (*RunnerAuthenticationToken, *Response, error) {
	res, resp, err := do[*RunnerAuthenticationToken](s.client,
		withMethod(http.MethodPost),
		withPath(routeRunnersIDResetAuthenticationToken, rid),
		withAPIOpts(nil),
		withRequestOpts(options...),
	)
	if err != nil {
