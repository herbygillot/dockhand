...
py-openssl's named subport, libfec, mpir, abendrot, bun, warzone2100, and fldigi reach local input assessment. mrustc's option threshold resolves, but its compiler-selection and compiler-flag probes of the installed toolchain still prevent a complete coverage claim; the refusal names their Portfile lines.
