...
- **next**: what happens or is needed next: "verification pending", "PR open, 3 checks pending", "merged; branches cleaned", "needs attention: patch rejects 4 hunks", "waiting for a Tart slot".
