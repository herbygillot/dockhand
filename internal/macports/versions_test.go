...
func TestVersionSelectionUsesTclFiltersAndMacPortsOrdering(t *testing.T) {
	...
	candidates := []macports.VersionCandidate{{Version: "1.9", URL: "https://github.com/o/p/archive/refs/tags/v1.9.tar.gz"}, {Version: "2.0", URL: "https://github.com/o/p/archive/refs/tags/v2.0.tar.gz"}, {Version: "1.10", URL: "https://github.com/o/p/archive/refs/tags/v1.10.tar.gz"}}
