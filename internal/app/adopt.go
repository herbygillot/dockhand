...
func (s *Services) Adopt(ctx context.Context, request AdoptRequest) (workflow.AdoptResult, error) {
	...
	return s.Workflow.AdoptContribution(ctx, workflow.AdoptRequest{Branch: request.Branch, Target: request.Target, Upstream: master.Commit, Platform: platform, DryRun: request.DryRun})
}
