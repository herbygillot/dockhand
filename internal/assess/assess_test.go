...
func TestAssessmentCapabilityDependencies(t *testing.T) {
	...
	allowed := map[string]bool{"git": true, "macports": true, "macports/dependency": true, "macports/portedit": true, "macports/portindex": true, "macports/survey": true, "progress": true, "record": true, "upstream": true}
