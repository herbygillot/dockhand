...
//
// Revision-bump jobs prepare immutable objects, checkpoint their candidate, and
...
// Version bumps, publication, dependent scheduling, and evidence reuse remain unfinished.
