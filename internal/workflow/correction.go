...
func (e *Engine) BindCorrection(ctx context.Context, input CorrectionRequest) (BoundCorrection, error) {
	...
	spec := record.JobSpec{Action: input.Action, Source: committed.Source(revision.Source.Base), Targets: targets, Destination: record.VerificationComplete, Verification: record.VerificationRequired, Build: build.Build, BuildRequirements: build.Requirements, IncludeDependents: input.IncludeDependents,
