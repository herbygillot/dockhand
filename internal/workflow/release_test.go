...
func resolvedFixture(f *fixture) record.Release {
	return record.Release{Requested: "2.0", Version: "2.0", Repository: "owner/project", Tag: "v2.0", Commit: strings.Repeat("a", 40), ObservedAt: f.now()}
}
...
func TestVersionBumpCheckpointsReleaseBeforePreparationAndResumesVerification(t *testing.T) {
	for _, verification := range []bool{false, true} {
		t.Run(map[bool]string{false: "branch", true: "verification"}[verification], func(t *testing.T) {
