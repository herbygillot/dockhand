...
// narrows the names with Result.Broke before asking.

// installNames lists the install names one installation publishes, once
// each and sorted.
//
// It reads install names and never paths, for the reason Delta does:
...
// question that made a link proof unearned. Result.Broke is what a caller
