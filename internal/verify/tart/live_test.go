...
func TestTartDriverProcess(t *testing.T) {
	...
	engine := &workflow.Engine{State: store, Repository: f.Repository, Provider: p, CallTimeout: 4 * time.Minute, LeaseDuration: 6 * time.Minute, RetryDelay: 100 * time.Millisecond}
